System.register(["@angular/core", "@angular/http", "rxjs/Observable", "../../auth.http"], function (exports_1, context_1) {
    ...
    var core_1, http_1, Observable_1, auth_http_1, UserRoleService;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            UserRoleService = (function () {
                function UserRoleService(http) {
                    this.http = http;
                    this.baseUrl = "api/userRole/"; // web api URL
                }
                // calls the [GET] /api/items/GetLatest/{n} Web API method to retrieve the latest items.  
                UserRoleService.prototype.getUserRoleList = function () {
                    var url = this.baseUrl + "GetUserRoleList";
                    return this.http.get(url)
                        .map(function (response) { return response.json(); })
                        .catch(this.handleError);
                };
                UserRoleService.prototype.get = function (id) {
                    if (id == null) {
                ...
                UserRoleService.prototype.getUserMatrix = function (id) {
                    if (id == null) {
                        throw new Error("id is required.");
                    }
                ...
                UserRoleService.prototype.add = function (data) {
                    console.log(data);
