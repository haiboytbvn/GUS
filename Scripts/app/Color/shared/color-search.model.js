System.register(["../../SearchGeneralFilter/shared/searchGeneralFilter.model"], function (exports_1, context_1) {
    ...
    var searchGeneralFilter_model_1, ColorSearchModel;
    return {
        setters: [
        ...
        execute: function () {
            ColorSearchModel = (function (_super) {
                __extends(ColorSearchModel, _super);
                function ColorSearchModel(Name, Code, BuyerCode, CompanyId, Paging) {
                ...
                return ColorSearchModel;
            }(searchGeneralFilter_model_1.SearchGeneralFilter));
            exports_1("ColorSearchModel", ColorSearchModel);
        }
    };
});
