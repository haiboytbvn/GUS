System.register(["@angular/core", "@angular/http", "rxjs/Observable", "../../auth.http"], function (exports_1, context_1) {
    ...
    var core_1, http_1, Observable_1, auth_http_1, ApplicationService;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            ApplicationService = (function () {
                function ApplicationService(http) {
                    this.http = http;
                    this.baseUrl = "api/application/"; // web api URL
                }
                // calls the [GET] /api/items/GetLatest/{n} Web API method to retrieve the latest items.  
                ApplicationService.prototype.getApplicationList = function (data) {
                ...
                ApplicationService.prototype.add = function (data) {
                ...
                ApplicationService.prototype.getbyId = function (id) {
                    if (id == null) {
                ...
                ApplicationService.prototype.getRequestOptions = function () {
