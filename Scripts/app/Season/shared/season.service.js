System.register(["@angular/core", "@angular/http", "rxjs/Observable", "../../auth.http"], function (exports_1, context_1) {
    ...
    var core_1, http_1, Observable_1, auth_http_1, SeasonService;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            SeasonService = (function () {
                function SeasonService(http) {
                    this.http = http;
                    this.baseUrl = "api/season/"; // web api URL
                }
                // calls the [GET] /api/items/GetLatest/{n} Web API method to retrieve the latest items.  
                SeasonService.prototype.getSeasonList = function (data) {
                ...
                SeasonService.prototype.add = function (data) {
                    console.log(data);
                ...
                SeasonService.prototype.get = function (id) {
                    if (id == null) {
                ...
                SeasonService.prototype.update = function (data) {
                ...
                SeasonService.prototype.getRequestOptions = function () {
