System.register(["@angular/core", "@angular/http", "rxjs/Observable", "../../auth.http"], function (exports_1, context_1) {
    ...
    var core_1, http_1, Observable_1, auth_http_1, AccessoryService;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            AccessoryService = (function () {
                function AccessoryService(http) {
                    this.http = http;
                    this.baseUrl = "api/accessory/"; // web api URL
                }
                // calls the [GET] /api/items/GetLatest/{n} Web API method to retrieve the latest items.  
                AccessoryService.prototype.getAccessoryList = function (data) {
                    var url = this.baseUrl + "GetAccessoryList";
                    return this.http.post(url, JSON.stringify(data), this.getRequestOptions())
                        .map(function (response) { return response.json(); })
                        .catch(this.handleError);
                };
                AccessoryService.prototype.uploadImage = function (imageData) {
                ...
                AccessoryService.prototype.add = function (data) {
                    console.log(data);
                ...
                AccessoryService.prototype.get = function (id) {
                    if (id == null) {
                ...
                AccessoryService.prototype.update = function (data) {
                ...
                AccessoryService.prototype.delete = function (id) {
                    var url = this.baseUrl + "DeleteAccessory/" + id;
                    return this.http.delete(url, new http_1.RequestOptions())
                        .catch(this.handleError);
                };
                AccessoryService.prototype.getRequestOptions = function () {
                ...
                AccessoryService.prototype.handleError = function (error) {
            ...
            exports_1("AccessoryService", AccessoryService);
        }
    };
});
