System.register(["../../SearchGeneralFilter/shared/searchGeneralFilter.model"], function (exports_1, context_1) {
    ...
    var searchGeneralFilter_model_1, WashSearchModel;
    return {
        setters: [
        ...
        execute: function () {
            WashSearchModel = (function (_super) {
                __extends(WashSearchModel, _super);
                function WashSearchModel(Name, Code, BuyerCode, CompanyId, Paging, TypeId, CateId, ProductNameId) {
                ...
                return WashSearchModel;
            }(searchGeneralFilter_model_1.SearchGeneralFilter));
            exports_1("WashSearchModel", WashSearchModel);
        }
    };
});
