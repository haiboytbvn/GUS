System.register(["@angular/core", "@angular/http", "rxjs/Observable", "../../auth.http"], function (exports_1, context_1) {
    ...
    var core_1, http_1, Observable_1, auth_http_1, TrainingItemService;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            TrainingItemService = (function () {
                function TrainingItemService(http) {
                    this.http = http;
                    this.baseUrl = "api/trainingitem/"; // web api URL
                }
                // calls the [GET] /api/items/GetLatest/{n} Web API method to retrieve the latest items.  
                TrainingItemService.prototype.getTrainingItemList = function (data) {
                ...
                TrainingItemService.prototype.get = function (id) {
                    if (id == null) {
                ...
                TrainingItemService.prototype.update = function (data) {
                ...
                TrainingItemService.prototype.delete = function (id) {
                    var url = this.baseUrl + "DeleteTrainingItem/" + id;
                    return this.http.delete(url, new http_1.RequestOptions())
                        .catch(this.handleError);
                };
                TrainingItemService.prototype.getRequestOptions = function () {
                ...
                TrainingItemService.prototype.handleError = function (error) {
            ...
            TrainingItemService = __decorate([
                core_1.Injectable(),
                __metadata("design:paramtypes", [auth_http_1.AuthHttp])
            ], TrainingItemService);
            exports_1("TrainingItemService", TrainingItemService);
        }
    };
});
