System.register(["@angular/core", "@angular/http", "rxjs/Observable", "../../auth.http"], function (exports_1, context_1) {
    ...
    var core_1, http_1, Observable_1, auth_http_1, VendorService;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            VendorService = (function () {
                function VendorService(http) {
                    this.http = http;
                    this.baseUrl = "api/Vendor/"; // web api URL
                }
                ...
                VendorService.prototype.add = function (data) {
                    console.log(data);
                ...
                VendorService.prototype.update = function (data) {
                ...
                VendorService.prototype.delete = function (id) {
                    var url = this.baseUrl + "DeleteVendor/" + id;
                    return this.http.delete(url, new http_1.RequestOptions())
                        .catch(this.handleError);
                };
                VendorService.prototype.getRequestOptions = function () {
