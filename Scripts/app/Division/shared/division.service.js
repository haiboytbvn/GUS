System.register(["@angular/core", "@angular/http", "rxjs/Observable", "../../auth.http"], function (exports_1, context_1) {
    ...
    var core_1, http_1, Observable_1, auth_http_1, DivisionService;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            DivisionService = (function () {
                function DivisionService(http) {
                    this.http = http;
                    this.baseUrl = "api/division/"; // web api URL
                }
                DivisionService.prototype.getDivisionList = function (data) {
                ...
                DivisionService.prototype.add = function (data) {
                ...
                DivisionService.prototype.get = function (id) {
                    if (id == null || id == "") {
                ...
                DivisionService.prototype.update = function (data) {
                ...
                DivisionService.prototype.getRequestOptions = function () {
            ...
            exports_1("DivisionService", DivisionService);
        }
    };
});
