System.register(["@angular/core", "@angular/http", "rxjs/Observable", "../../auth.http"], function (exports_1, context_1) {
    ...
    var core_1, http_1, Observable_1, auth_http_1, DepartmentService;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            DepartmentService = (function () {
                function DepartmentService(http) {
                    this.http = http;
                    this.baseUrl = "api/department/"; // web api URL
                }
                // calls the [GET] /api/items/GetLatest/{n} Web API method to retrieve the latest items.  
                DepartmentService.prototype.getDepartmentList = function (data) {
                ...
                DepartmentService.prototype.add = function (data) {
                    console.log(data);
                ...
                DepartmentService.prototype.get = function (id) {
                    if (id == null || id == "") {
                ...
                DepartmentService.prototype.getRequestOptions = function () {
