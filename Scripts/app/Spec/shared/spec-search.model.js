System.register(["../../SearchGeneralFilter/shared/searchGeneralFilter.model"], function (exports_1, context_1) {
    ...
    var searchGeneralFilter_model_1, SpecSearchModel;
    return {
        setters: [
        ...
        execute: function () {
            SpecSearchModel = (function (_super) {
                __extends(SpecSearchModel, _super);
                function SpecSearchModel(Name, Code, BuyerCode, CompanyId) {
                ...
                return SpecSearchModel;
            }(searchGeneralFilter_model_1.SearchGeneralFilter));
            exports_1("SpecSearchModel", SpecSearchModel);
        }
    };
});
