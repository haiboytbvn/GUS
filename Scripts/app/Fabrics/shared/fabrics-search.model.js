System.register(["../../SearchGeneralFilter/shared/searchGeneralFilter.model"], function (exports_1, context_1) {
    ...
    var searchGeneralFilter_model_1, FabricsSearchModel;
    return {
        setters: [
        ...
        execute: function () {
            FabricsSearchModel = (function (_super) {
                __extends(FabricsSearchModel, _super);
                function FabricsSearchModel(Name, Code, BuyerCode, CompanyId, Paging, TypeId, CateId, ProductNameId) {
                ...
                return FabricsSearchModel;
            }(searchGeneralFilter_model_1.SearchGeneralFilter));
            exports_1("FabricsSearchModel", FabricsSearchModel);
        }
    };
});
