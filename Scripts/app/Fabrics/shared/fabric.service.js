System.register(["@angular/core", "@angular/http", "rxjs/Observable", "../../auth.http"], function (exports_1, context_1) {
    ...
    var core_1, http_1, Observable_1, auth_http_1, FabricsService;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            FabricsService = (function () {
                function FabricsService(http) {
                    this.http = http;
                    this.baseUrl = "api/fabric/"; // web api URL
                }
                // calls the [GET] /api/items/GetLatest/{n} Web API method to retrieve the latest items.  
                FabricsService.prototype.getFabricsList = function (data) {
                    console.log(data);
                ...
                FabricsService.prototype.add = function (data) {
                    console.log(data);
                ...
                FabricsService.prototype.get = function (id) {
                    if (id == null) {
                ...
                FabricsService.prototype.update = function (data) {
                ...
                FabricsService.prototype.delete = function (id) {
                    var url = this.baseUrl + "DeleteFabrics/" + id;
                    return this.http.delete(url, new http_1.RequestOptions())
                        .catch(this.handleError);
                };
                FabricsService.prototype.getRequestOptions = function () {
                ...
                FabricsService.prototype.handleError = function (error) {
            ...
            exports_1("FabricsService", FabricsService);
        }
    };
});
