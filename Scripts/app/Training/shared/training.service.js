System.register(["@angular/core", "@angular/http", "rxjs/Observable", "../../auth.http"], function (exports_1, context_1) {
    ...
    var core_1, http_1, Observable_1, auth_http_1, TrainingService;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            TrainingService = (function () {
                function TrainingService(http) {
                    this.http = http;
                    this.baseUrl = "api/training/"; // web api URL
                }
                // calls the [GET] /api/items/GetLatest/{n} Web API method to retrieve the latest items.  
                TrainingService.prototype.getTrainingList = function (data) {
                ...
                TrainingService.prototype.add = function (data) {
                    console.log(data);
                ...
                TrainingService.prototype.get = function (id) {
                    if (id == null) {
                ...
                TrainingService.prototype.update = function (data) {
                ...
                TrainingService.prototype.getRequestOptions = function () {
            ...
            exports_1("TrainingService", TrainingService);
        }
    };
});
