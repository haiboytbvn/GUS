System.register(["@angular/core", "@angular/http", "rxjs/Observable", "../../auth.http"], function (exports_1, context_1) {
    ...
    var core_1, http_1, Observable_1, auth_http_1, MenuService;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            MenuService = (function () {
                function MenuService(http) {
                    this.http = http;
                    this.baseUrl = "api/navigation/"; // web api URL
                }
                MenuService.prototype.getAccessoryLeftMenu = function () {
                ...
                MenuService.prototype.getFabLeftMenu = function () {
                ...
                MenuService.prototype.getWashLeftMenu = function () {
                ...
                MenuService.prototype.getGraphicLeftMenu = function () {
                ...
                MenuService.prototype.getRequestOptions = function () {
