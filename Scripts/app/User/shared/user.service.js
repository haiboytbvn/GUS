System.register(["@angular/core", "@angular/http", "rxjs/Observable", "../../auth.http"], function (exports_1, context_1) {
    ...
    var core_1, http_1, Observable_1, auth_http_1, ApplicationUserService;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            ApplicationUserService = (function () {
                function ApplicationUserService(http) {
                    this.http = http;
                    this.baseUrl = "api/applicationuser/"; // web api URL
                }
                // calls the [GET] /api/items/GetLatest/{n} Web API method to retrieve the latest items.  
                ApplicationUserService.prototype.getApplicationUserList = function () {
                ...
                ApplicationUserService.prototype.get = function (id) {
                    if (id == null) {
                ...
                ApplicationUserService.prototype.add = function (data) {
                    console.log(data);
                ...
                ApplicationUserService.prototype.update = function (data) {
                ...
                ApplicationUserService.prototype.delete = function (id) {
                    var url = this.baseUrl + "DeleteApplicationUser/" + id;
                    return this.http.delete(url, new http_1.RequestOptions())
                        .catch(this.handleError);
                };
                ApplicationUserService.prototype.getRequestOptions = function () {
            ...
            exports_1("ApplicationUserService", ApplicationUserService);
        }
    };
});
